...
- Part A: Repetition
    ...
    - [Lecture A](Contents/Material/Part C/Lecture.html){target="_blank"}
    - [Exercise A](Contents/Material/Part C/Exercise.html){target="_blank"}
    - [Solution A](Contents/Material/Part C/Exercise.html){target="_blank"}
