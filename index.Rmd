...
|             | *Break*                                         |             
| 13.00-15.30 | Preparing large data for analysis (E)           |
| *Thursday*  |                                                 |
| 09.00-12.00 | Analysis of large data (F)                      |
...
- Part B: Sampling
    ...
    - [Lecture C](Contents/Material/Part B/Sampling.html){target="_blank"}
    - [Exercise C](Contents/Material/Part B/Sampling_Exercises.html){target="_blank"}
    - [Solution C](Contents/Material/Part B/Sampling_Exercises.html){target="_blank"}
    
- Part C: Estimation and calibration

    - [Lecture D](Contents/Material/Part C/Estimation.html){target="_blank"}
    - [Exercise D](Contents/Material/Part C/Estimation_Exercises.html){target="_blank"}
    - [Solution D](Contents/Material/Part C/Estimation_Exercises.html){target="_blank"}    

## Column 2

### Useful references
- [tidyverse.com](https://www.tidyverse.org/)
...
- Part D: Functional Programming
    ...
    - [Lecture E](Contents/Material/Part D/Lecture.html){target="_blank"}
    - [Exercise E](Contents/Material/Part D/Exercise.html){target="_blank"}
    - [Solution E](Contents/Material/Part D/Exercise.html){target="_blank"}
