...
- Part D: Functional Programming
    ...
    - [Solution D1](Contents/Material/Part D/Solution_D1.html){target="_blank"}
    ...
    - Data:
       ...
       - [cars_2.csv](Contents/Material/Part D/cars_1.csv){target="_blank"}
       - [cars_3.csv](Contents/Material/Part D/cars_1.csv){target="_blank"}
       - [cars_4.csv](Contents/Material/Part D/cars_1.csv){target="_blank"}
       - [cars_5.csv](Contents/Material/Part D/cars_1.csv){target="_blank"}
